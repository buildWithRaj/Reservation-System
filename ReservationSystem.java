package jdbc.reservationSystem;
...
public class ReservationSystem {
    ...
    private static final String password = "Raj@1234";
    ...
    private static void viewReservations(Connection connection) throws SQLException {
        ...
        try (Statement statement = connection.createStatement();
            ...
            System.out.println("+---------------+---------------+------------+--------------+-----------------");
            System.out.println("| Reservaion ID | Guest         | Room Number| Contact No.  | Reservation Date");
            System.out.println("+---------------+---------------+------------+--------------+-----------------");
    ...
    private static void updateReservation(Connection connection, Scanner scanner) throws SQLException {
        try {
            ...
            if (!reservationExists(connection, reservationId)) {
                System.out.println("Reservation npt found for the given ID.");
                return;
            }
    ...
    public static void exit() throws InterruptedException {
        ...
        System.out.println();
        System.out.println("Thankyu For Using Hotel Reservation System !!!");
    }
